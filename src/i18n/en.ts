...
export const en = {
  about: {
    ...
    toolsButtonLabel: 'Online Tools',
    toolsButtonAccessibilityHint: 'Opens the Lyric Editor and Setlist Builder web tools directly, skipping the general website.',
    toolsFailedTitle: "Couldn't open the online tools",
    toolsFailedMessage: (url: string) => `Visit ${url} directly instead.`,
  ...
  library: {
    ...
    filterButtonLabel: (mode: string): string => `Filter: ${mode}`,
    filterButtonHint: 'Swipe up or down to change, or tap to cycle.',
    filterText: 'Filter',
    nextFilterActionLabel: 'Next filter',
    previousFilterActionLabel: 'Previous filter',
    filterModeLibraryLabel: 'All Songs',
    filterModeNoActiveSetlistLabel: 'Active Setlist (none active)',
    filterModeNotebookLabel: 'Notebook',
    noActiveSetlistFilterText: 'No setlist is active. Start one from Setlists to use this filter.',
    emptySetlistFilterText: (name: string): string =>
      `No songs from "${name}" are downloaded to this device yet.`,
    emptyNotebookText: 'Nothing in your notebook yet. Add a song there from Dropbox to see it here.',
    notebookRowAccessibilityHint: 'Double tap to open. Swipe up or down to promote to your library.',
    promoteToLibraryActionLabel: 'Promote to Library',
    promotedToLibraryAnnouncement: (name: string): string => `Promoted ${name} to your library`,
    emptyNotebookFileAlertTitle: 'Nothing to load',
    emptyNotebookFileAlertMessage: (name: string): string => `"${name}" doesn't have any lyric lines in it.`,
    notebookOpenFailedAlertTitle: "Couldn't open that song",
    notebookPromoteFailedAlertTitle: "Couldn't promote that song",
    ...
    addToSetlistActionLabel: (setlistName: string): string => `Add to ${setlistName}`,
    addToNewSetlistActionLabel: 'Add to New Setlist',
    addedToSetlistAnnouncement: (setlistName: string): string => `Added to ${setlistName}`,
    alreadyInSetlistAnnouncement: (setlistName: string): string => `Already in ${setlistName}`,
  ...
  promptScreen: {
    ...
    randomSetlistLabel: 'Random next song',
    randomSetlistHint: 'Swipe up to turn on, down to turn off. When on, the next song is picked randomly instead of in order, without repeating a song until every song in the setlist has played.',
    randomSetlistOnActionLabel: 'Turn on',
    randomSetlistOffActionLabel: 'Turn off',
    randomSetlistStateOnLabel: 'On',
    randomSetlistStateOffLabel: 'Off',
