...
export const uk: Strings = {
  ...
  inputScreen: {
    ...
    lyricsLabel: 'Текст пісні — один рядок на підказку',
    titlePlaceholder: 'Назва пісні',
    lyricsPlaceholder:
      'Вставте текст пісні сюди.\nПо одному рядку за раз.\n\nЗа бажанням позначайте розділи через -- або [Приспів].',
  ...
  voiceSettings: {
    ...
    showAllLanguagesLabel: 'Показати всі мови',
    showAllLanguagesHint:
